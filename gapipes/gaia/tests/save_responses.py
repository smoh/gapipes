...
d["sync_query"] = tap._post_query("select top 5 * from gaiadr1.gaia_source")
...
d["sync_wrong_query"] = tap._post_query("select top 5 * from gg.gaia_source")
d["sync_query_with_upload"] = tap._post_query(
    "select top 5 * from tap_upload.foobar",
    upload_resource=mytable,
