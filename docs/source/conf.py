...
latex_documents = [
    (master_doc, "gapipes.tex", "gapipes Documentation", "Semyeong Oh", "manual")
]
...
man_pages = [(master_doc, "gapipes", "gapipes Documentation", [author], 1)]
